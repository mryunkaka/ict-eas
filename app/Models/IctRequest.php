...
class IctRequest extends Model
{
    public const STATUS_LABELS = [
        ...
        'ttd_in_progress' => 'Validasi Staff ICT',
        'checked_by_asmen' => 'Validasi Asmen ICT',
        'progress_ppnk' => 'Proses PPNK / PPK',
        'progress_verifikasi_audit' => 'Verifikasi Audit',
        'progress_ppm' => 'Proses PPM',
        'progress_po' => 'Proses PO',
        'progress_waiting_goods' => 'Menunggu Barang Datang',
        'progress_goods_arrived' => 'Barang Sudah Datang',
        'approved_by_manager' => 'Disetujui Manager ICT',
        'completed' => 'Barang Telah Diserahkan',
