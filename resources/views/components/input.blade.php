...
@php
    ...
    $inputClasses = [
        'default' => 'h-10 w-full rounded-xl border border-ink-200 bg-white px-3.5 py-0 text-[13px] text-ink-900 outline-none ring-0 transition placeholder:text-ink-500 focus:border-brand-500',
        'compact' => 'h-8 w-full rounded-xl border border-ink-200 bg-white px-3 py-0 text-xs text-ink-900 outline-none ring-0 transition placeholder:text-ink-500 focus:border-brand-500',
    ];

    $passwordInputClasses = [
        'default' => 'h-10 w-full rounded-xl border border-ink-200 bg-white px-3.5 py-0 pr-12 text-[13px] text-ink-900 outline-none ring-0 transition placeholder:text-ink-500 focus:border-brand-500',
        'compact' => 'h-8 w-full rounded-xl border border-ink-200 bg-white px-3 py-0 pr-10 text-xs text-ink-900 outline-none ring-0 transition placeholder:text-ink-500 focus:border-brand-500',
    ];
@endphp
